...
#define INT8_QUANTIZATION 0   								// 1 activate the INT8 (1 byte) quantization, 0 use Float32 (4 bytes)

#if INT8_QUANTIZATION
    #define DATA_BYTES 1
    #define QUANT_MULTIPLIER 4 								// Using the same SRAM size, we can store 4 times more elements with INT8 quantization compared to Float32.
#else
    #define DATA_BYTES 4
...
#define USE_BIAS 1      									// 1: Enable in-transit Bias initialization (cNoC Way 3). 0: Bias-less models (e.g., LLaMA)
